...
ablation_datasets_repository = "./ablation_datasets/" #not gitignored

download_format_uciopenml = True
download_format_kaggle = True
rerun_download_format = False
...
os.makedirs(ablation_datasets_repository, exist_ok = True)
...
#add additional infos on generated datasets
...
#cleanup
abalone_dataset = "regression12.npy"
concrete_dataset = "regression15.npy"
for ablation_dataset in [abalone_dataset, concrete_dataset]:
    shutil.copyfile(preprocessed_datasets_repository+ablation_dataset, ablation_datasets_repository+ablation_dataset)
