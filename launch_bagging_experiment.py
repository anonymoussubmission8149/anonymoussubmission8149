...
parser = argparse.ArgumentParser(
    description='launch bagging experiment',
)
parser.add_argument(
    '--input_repository',
    type=str,
...
if __name__ == '__main__':
    ...
    ablation_list = ["ablation_width", "ablation_depth", "ablation_batch", "ablation_dropout", "fast_only"]
    if args.method == "all": 
    ...
    for weak_learner_infos in get_benchmarked_methods(methods, regression = regression):
        weak_learners = [weak_learner_infos]
        method_tag = weak_learner_infos[1]
        
        run_bagging(weak_learners,
            method_tag,
            datasets, 
            task_name, 
            input_repository, 
            ...
            weak_learner_seeds = method_seeds,
            train_size = train_size,
            n_features = n_features,
            was_stratified = should_stratify,
